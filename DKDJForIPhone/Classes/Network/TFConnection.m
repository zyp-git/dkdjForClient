...
- (void)get:(NSString*)aURL
{
    ...
    [req setValue:@"ihangjing.com" forHTTPHeaderField:@"User-Agent"];
...
-(void)post:(NSString*)aURL body:(NSString*)body
{
    ...
    [req setValue:[NSString stringWithFormat:@"%ld", (long)contentLength] forHTTPHeaderField:@"Content-Length"];
...
- (void)Upload:(UIImage *)image type:(NSString *)type dataID:(NSString *)dataid imageExtName:(NSString *)extName url:(NSString*)aURL
{
    [connection release];
    [buf release];
    statusCode = 0;
    ...
    [req setHTTPMethod:@"POST"];
    [req setValue:contentType forHTTPHeaderField:@"Content-Type"];
    [req addValue:type forHTTPHeaderField: @"type"];
    [req addValue:extName forHTTPHeaderField: @"ext"];
    [req addValue:dataid forHTTPHeaderField: @"id"];
