...
- (void)textFieldDidEndEditing:(UITextField *)textField {
	if (self.delegate && [self.delegate respondsToSelector:@selector(tableViewCell:didEndEditingWithString:)]) {
		[self.delegate tableViewCell:self didEndEditingWithString:self.stringValue];
	}
