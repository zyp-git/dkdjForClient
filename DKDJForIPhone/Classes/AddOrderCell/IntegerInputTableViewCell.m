...
- (BOOL)resignFirstResponder {
	if (valueChanged && self.delegate && [self.delegate respondsToSelector:@selector(tableViewCell:didEndEditingWithInteger:)]) {
		[self.delegate tableViewCell:self didEndEditingWithInteger:self.numberValue];
	}
