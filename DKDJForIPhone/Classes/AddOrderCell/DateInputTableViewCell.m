...
- (void)dateChanged:(id)sender {
	...
	if (self.delegate && self.dateValue && [self.delegate respondsToSelector:@selector(tableViewCell:didEndEditingWithDate:)]) {
		[self.delegate tableViewCell:self didEndEditingWithDate:self.dateValue];
	}
}
